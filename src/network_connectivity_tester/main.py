...
def parse_arguments():
    ...
    parser.add_argument("file_path", help="Path to the CSV file containing IP addresses")
    parser.add_argument("column_name", help="Name of the column containing IP addresses")
    parser.add_argument("--protocols", nargs='+', choices=['snmp', 'ssh'], default=['snmp', 'ssh'],
...
def main():
    ...
    logging.info(f"Starting connectivity tests with file: {args.file_path}, column: {args.column_name}")
